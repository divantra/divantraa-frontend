              ...
              <>
                ...
                <div className="flex flex-col items-center text-center pt-10">
                  ...
                  <Link
                    href="/products"
                    onClick={closeCart}
                    className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#407a4a] text-white px-6 py-3 text-sm font-medium hover:opacity-90"
                  >
                    Continue Shopping
                  </Link>
                </div>
                ...
                <div className="flex-1 overflow-y-auto px-6 py-4">
                  <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center gap-3">
                      <ShoppingBag size={24} className="text-[#407a4a]" />
                      <h3 className="font-display text-xl text-[#407a4a]">Cart details</h3>
                    </div>
                    <p className="text-sm font-medium text-ink/80">Total Items: {items.length}</p>
                  </div>
                  ...
                  <div>
                    <h4 className="font-display text-base mb-2">You might also like</h4>
                    <div className="text-sm text-center text-ink/50 py-8 bg-ink/5 rounded-lg">
                      Product suggestions will be here.
                    </div>
                  </div>
                </div>
